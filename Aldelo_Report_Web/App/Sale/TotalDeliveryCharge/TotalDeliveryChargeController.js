app.controller('TotalDeliveryChargeController', ["$scope", '$filter', "totallDeliveryChargeService", function ($scope, $filter, totallDeliveryChargeService) {
    ...
    $scope.id;
    $scope.sale;
    $scope.getTotalDeliveryCharge = function () {
        ...
        totallDeliveryChargeService.getTotalDeliveryCharge(value).then(function (result) {
    ...
    $scope.getInitialData = function () {
        totallDeliveryChargeService.getInitialData().then(function (result) {
