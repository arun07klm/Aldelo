app.controller('ComplementaryOrder', ["$scope", '$filter', "complementaryorderService", function ($scope, $filter, complementaryorderService) {
    ...
    $scope.id;
    $scope.sale;
    $scope.getComplemnetaryOrder = function () {
        ...
        complementaryorderService.getComplemnetaryOrder(value).then(function (result) {
    ...
    //    driverDeliveryService.getInitialData().then(function (result) {
