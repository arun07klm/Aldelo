app.controller('fastestMovingItemController', ["$scope",'$filter', "fastestMovingItemService", function ($scope,$filter, fastestMovingItemService) {
    ...
    $scope.id;
    $scope.sale;
    $scope.getAllFastestMovingItem = function () {
        ...
        fastestMovingItemService.getAllFastestMovingItem(value).then(function (result) {
