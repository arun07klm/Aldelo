app.controller('TotalPayoutController', ["$scope", '$filter', "totalPayoutService", function ($scope, $filter, totalPayoutService) {
    ...
    $scope.getTotalPayout = function () {
        ...
        totalPayoutService.getTotalPayout(value).then(function (result) {
