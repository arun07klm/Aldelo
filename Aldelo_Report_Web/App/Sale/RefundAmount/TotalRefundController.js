app.controller('TotalRefundController', ["$scope", '$filter', "totallRefundService", function ($scope,$filter, driverDeliveryService) {
    ...
    $scope.getTotalDeliveryCharge = function () {
        ...
        driverDeliveryService.getTotalRefundAmount(value).then(function (result) {
